...
export type RSSChannel = {
	...
	image: RSSImage, // Specifies a GIF, JPEG or PNG image that can be displayed with the channel.
	...
	textInput: RSSTextInput, // Specifies a text input box that can be displayed with the channel.
