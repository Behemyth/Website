  ...
  div(class="md:flex sm:items-center md:justify-between")
    span(class="mb-6 md:mb-0")
      NuxtLink.flex.items-center(to="/")
        img.mr-3.h-12.rounded-full(src="https://www.gravatar.com/avatar/293a56bef971ab4999d6230491957d33?s=200" alt="Asher's Face")
...
<script setup>
const { data } = await useAsyncData('footer', () => queryContent('/').where({ _partial: true }).find())
</script>
